...
class TestText(unittest.TestCase):
    ...
    def test_string_to_float(self):
        df = pd.DataFrame({'probs': ['0.3', '0.8', 2]})
        result = pd.DataFrame({'probs': [0.3, 0.8, 2]}).probs
    ...
    def test_remove_string(self):
        ...
        result = pd.DataFrame({'description': ['circus at whitehouse', 'politics suck', 'athouse']}).description
    ...
    def test_replace_string_with_nan(self):
        ...
        result = pd.DataFrame({'description': ['circus at the whitehouse', np.nan]}).description
    ...
    def test_replace_nan_with_string(self):
        ...
        result = pd.DataFrame({'description': ['circus at the whitehouse', '']}).description
    ...
    def test_like_float_to_int(self):
        ...
        result = pd.DataFrame({'probs': [1, 2, 2]}).probs
